...
Run verification steps to ensure nothing broke:

1. **Run tests** if a test script exists in package.json:
...
3. **Run build** if a build script exists:
...
2. Create a descriptive commit message:
   ...
   ```
3. Commit: `git commit -m "chore: update dependencies"`

### 8. Provide Summary

Provide a comprehensive summary including:

- What packages were updated (with version changes)
- Any packages that were NOT updated (likely due to major version constraints)
...
- Only update within semver ranges - major version updates require manual review
