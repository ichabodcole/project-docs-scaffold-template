...
- **Preserve design rationale** - Capture *why* interaction decisions were made, not just what was built
...
- **UI component choices** - When it matters *why* a specific component or pattern was selected
...
- **Interaction patterns with important rationale** - When knowing *why* a pattern exists matters
...
- **Call out design rationale** - Help developers understand *why* something is designed a certain way so they don't change it on a whim
