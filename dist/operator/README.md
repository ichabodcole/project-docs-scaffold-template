# operator — Cross-Agent Skills Package
...
```bash
opkg install gh@ichabodcole/project-docs-scaffold-template/dist/operator
```
...
```json
{
  "skills_paths": ["<clone-path>/dist/operator/skills"]
}
```
