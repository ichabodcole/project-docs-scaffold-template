...
| [migrations/v2.8-to-v2.9.md](migrations/v2.8-to-v2.9.md) | 2.8     | 2.9.0 | `[ ! -f docs/.pdocs-seed.json ]`                                 | Templates become **seeded** — the scaffold records what it installed in `docs/.pdocs-seed.json`, and a later migration updates a template only while you have not edited it. Also opens the type vocabulary via `lint.types`, and makes `pdocs find --type` refuse an unknown type instead of returning nothing at exit 0 |
