...
name: media-library
description: >
  Implement a full-featured media library with admin UI for uploading,
  organizing, and managing audio and image assets with S3-compatible storage,
  AI-assisted metadata generation, and maintenance tools. Use when the user asks
  to "add a media library", "build asset management", "implement media uploads",
