# recipes — Cross-Agent Skills Package
...
| ------ | ----- | -------------------------------- |
| Skills | 14    | Yes — Agent Skills open standard |
...
```bash
opkg install gh@ichabodcole/project-docs-scaffold-template/dist/recipes
```
...
```json
{
  "skills_paths": ["<clone-path>/dist/recipes/skills"]
}
```
