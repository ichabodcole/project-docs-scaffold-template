# hivemind — Cross-Agent Skills Package
...
| ------ | ----- | -------------------------------- |
| Skills | 4     | Yes — Agent Skills open standard |
...
```bash
opkg install gh@ichabodcole/project-docs-scaffold-template/dist/hivemind
```
...
```json
{
  "skills_paths": ["<clone-path>/dist/hivemind/skills"]
}
```
